...
urlpatterns = [
    ...
    # Cart / Checkout
    path("checkout_cart/<slug:slug>/", views.checkout_cart, name="checkout_cart"),
    ...
    path("product/phones/<str:company_name>/", views.product_by_company, name="product_by_company"),
    path("product/tablets/<str:company_name>/", views.product_by_company_tablets, name="product_by_company_tablets"),
    path("product/laptops/<str:company_name>/", views.product_by_company_laptops, name="product_by_company_laptops"),
